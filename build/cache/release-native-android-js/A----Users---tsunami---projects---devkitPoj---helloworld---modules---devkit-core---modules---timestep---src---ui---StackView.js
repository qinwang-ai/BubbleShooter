14625f68ffe4aa8781b1421b6c4b7f42
/*
...
*/
jsio("import ui.View as View");jsio("import animate");var Users_tsunami_projects_devkitPoj_helloworld_modules_devkit_core_modules_timestep_src_ui_StackView=__class__;
exports=Users_tsunami_projects_devkitPoj_helloworld_modules_devkit_core_modules_timestep_src_ui_StackView(function(){return this.init&&this.init.apply(this,arguments)},View,function(e){this.init=function(a){a=merge(a,{layout:"box"});e(this,"init",[a]);this.stack=[]};this.getStack=function(){return this.stack};this.getCurrentView=function(){return!this.stack.length?null:this.stack[this.stack.length-1]};this.push=function(a,b,c){!this.stack[0]&&!1!==b&&(b=!0);var d=this.getCurrentView();d&&this._hide(d,
