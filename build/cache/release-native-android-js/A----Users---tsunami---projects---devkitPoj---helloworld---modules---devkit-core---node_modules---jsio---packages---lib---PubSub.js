9041ec7fa653594dd6b54bc68f947966
jsio("from ..std.uuid import uuid");var ctx=jsio.__env.global,SLICE=Array.prototype.slice,Users_tsunami_projects_devkitPoj_helloworld_modules_devkit_core_node_modules_jsio_packages_lib_PubSub=__class__;
exports=Users_tsunami_projects_devkitPoj_helloworld_modules_devkit_core_node_modules_jsio_packages_lib_PubSub(function(){return this.init&&this.init.apply(this,arguments)},function(){this.init=function(){};this.publish=function(a){if(this._subscribers){var b=SLICE.call(arguments,1);if(this._subscribers.__any)for(var e=[a].concat(b),d=this._subscribers.__any.slice(0),c=0,f;f=d[c];++c)f.apply(ctx,e);if(!this._subscribers[a])return this;d=this._subscribers[a].slice(0);for(c=0;f=d[c];++c)f.apply(ctx,
