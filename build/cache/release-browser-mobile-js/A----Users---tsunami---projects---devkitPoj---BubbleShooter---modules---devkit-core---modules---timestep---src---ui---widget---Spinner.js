ce5be1e9f1ae1fdc231c4e5c0b64189b
/*
...
*/
jsio("import ui.View as View");var Users_tsunami_projects_devkitPoj_BubbleShooter_modules_devkit_core_modules_timestep_src_ui_widget_Spinner=__class__;
exports=Users_tsunami_projects_devkitPoj_BubbleShooter_modules_devkit_core_modules_timestep_src_ui_widget_Spinner(function(){return this.init&&this.init.apply(this,arguments)},View,function(k){var l={cycles:0.5,radius:10,spokes:20,thickness:2,trail:10,color:"#ffffff",backgroundColor:"rgba(0, 0, 0, 0.5)",layout:"box"};this.tag="Spinner";this._t=0;this.init=function(a){this._opts=merge(a,l);this._step=2*Math.PI/this._opts.spokes;k(this,"init",[this._opts])};this.tick=function(a){this._t+=a;var a=this._t/
