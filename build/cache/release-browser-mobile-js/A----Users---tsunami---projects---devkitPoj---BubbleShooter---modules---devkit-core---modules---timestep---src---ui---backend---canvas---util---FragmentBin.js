df6310ccc2d25ba9177d466c2a9fd5bd
/*
...
*/
var Users_tsunami_projects_devkitPoj_BubbleShooter_modules_devkit_core_modules_timestep_src_ui_backend_canvas_util_FragmentBin=__class__,FragmentBin=exports=Users_tsunami_projects_devkitPoj_BubbleShooter_modules_devkit_core_modules_timestep_src_ui_backend_canvas_util_FragmentBin(function(){return this.init&&this.init.apply(this,arguments)},"TextBin",function(){this.init=function(a){this.width=a.width;this.height=a.height;this.x=a.x;this.y=a.y};this.size=function(){return this.width*this.height};this.split=
