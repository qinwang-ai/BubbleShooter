4b22991b55a96282529b93445c65ce8a
/*
...
var MAX_REFLOW_THRESHOLD=20,_pool=new (Class(function(){this._pool=[];this.recycle=function(a){a.view=null;this._pool.push(a)};this.get=function(a){var b=this._pool.pop()||{};b.view=a;b.count=0;b.needsReflow=!1;return b}})),Users_tsunami_projects_devkitPoj_BubbleShooter_modules_devkit_core_modules_timestep_src_ui_backend_ReflowManager=__class__,ReflowManager=exports=Users_tsunami_projects_devkitPoj_BubbleShooter_modules_devkit_core_modules_timestep_src_ui_backend_ReflowManager(function(){return this.init&&
