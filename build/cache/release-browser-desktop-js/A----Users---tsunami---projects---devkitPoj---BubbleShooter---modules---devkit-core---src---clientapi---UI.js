cc21ad535dbc02b4535e642269e472b6
/*
...
*/
jsio("import device");jsio("import ui.widget.Spinner as Spinner");var config=window.CONFIG,Users_tsunami_projects_devkitPoj_BubbleShooter_modules_devkit_core_src_clientapi_UI=__class__;
exports=Users_tsunami_projects_devkitPoj_BubbleShooter_modules_devkit_core_src_clientapi_UI(function(){return this.init&&this.init.apply(this,arguments)},function(){this._spinnerCounter=0;jsio("import device");var a;this._scale=a=navigator.displayMetrics?navigator.displayMetrics.densityDpi/160:!CONFIG.scaleDPR&&device.isMobileBrowser?1:window.devicePixelRatio||1;this.setTargetDensity=function(b){switch(b){case "high":this._scale=0.5*a;break;case "medium":this._scale=0.75*a;break;default:this._scale=
